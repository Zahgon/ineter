...
//@formatter:off
public interface IPRange<R extends IPRange<R, S, I, L>, S extends IPSubnet<S, R, I, L>, I extends IPAddress & Comparable<I>, L extends Number & Comparable<L>> extends Iterable<I>, Serializable {
